...
/* A type annotation. It is telling the compiler that the variable `cmdHistory` is an array of strings. */
...
const Terminal = () => {
  ...
  const [hints, setHints] = useState(["fdhjgfghbdjhf"]);
  ...
  return (
    <Wrapper className="bg-black text-white h-full justify-end" data-testid="terminal-wrapper" ref={containerRef}>
      {hints.length > 1 && (
        <div>
          {hints.map(hCmd => (
